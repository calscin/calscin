//! Type lowering of the append pass.
...
pub fn lower_stage_0_append_pass_struct_declaration(
    node: ASTNode,
    ...
    } = node.kind.clone()
    {
        ...
        tree.traverse_to_append(path_to_append_to, ModuleTreeEntry::EmptyType, &node)
    } else {
